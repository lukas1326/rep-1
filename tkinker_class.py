...
class App(tk.Tk):
    ...
    def open_default(self):
        ...
        default_text_read = text_file.read()
        self.textview.insert(tk.END,default_text_read)
    ...
    def _setup_menus(self):
        ...
        self.file_menu.add_command(label="Open default.txt", command=self.open_default)

...
# set/store these three parameters inside objects variables of 
# the same name (remember to use self!)

#  print on the screen "New Song made" - 
# (try also printing here author and title!)
